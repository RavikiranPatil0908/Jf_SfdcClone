...
(function ($) {
    $.fn.verySimpleImageViewer = function( options ) {
        ...
        self.loadToolbar = function(self) {
            ...
            zoomIn.className='jqvsiv_toolbarButton zoomingButton';
            ...
            zoomOut.className='jqvsiv_toolbarButton zoomingButton';
            ...
            center.className='jqvsiv_toolbarButton zoomingButton';
