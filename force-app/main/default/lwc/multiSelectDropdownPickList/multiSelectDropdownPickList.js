...
export default class MultiSelectDropdownPickList extends LightningElement {
    ...
    set options(value) {
        // console.log('this.inputOptions ' + value)
        // console.log('this.inputOptions ' + JSON.stringify(value))
        // console.log('before' + this.optionData);
        var optionData = value ? (JSON.parse(JSON.stringify(value))) : null;
        this.optionData = optionData;
        // console.log('after --' +JSON.stringify(this.optionData));
    }
    ...
    set selectedvalue(value) {
        var values = value ? (JSON.parse(value)) : null;
        if (this.optionData) {
